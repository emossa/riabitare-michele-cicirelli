...
export const QuoteRequestSent = ({
    ...
    <Html>
        <Head />
        <Preview>Hai inviato una richiesta di preventivo</Preview>
        <Body style={main}>
            <Container style={container}>
                ...
                <Text style={text}>
                    Hai inviato una richiesta di preventivo ecco i dettagli:
                </Text>
...
export default QuoteRequestSent;
